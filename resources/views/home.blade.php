...
@section('content')
    <div class="container-fluid d-flex justify-content-center align-items-center vh-100">
        <div class="text-center">
            ...
            <form action="{{ route('form.index') }}" method="get"> <!-- Formulario para redirigir al cuestionario inicial -->
                <button type="submit" class="cta"> <!-- Botón para iniciar el cuestionario -->
                    <span>{{ __('Start') }}</span>
