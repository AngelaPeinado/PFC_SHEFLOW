...
@section('content')
    ...
    <div class="custom-row">
        ...
        <div class="custom-column">
            <div class="text-container">
                <h3>Nuestros valores son claros</h3>
                <br>
                <ul>
                    <li>Empoderamiento: Creemos en capacitar a las mujeres para que tomen el control de su salud y su vida.</li>
                    <li>Educación: Valoramos la información precisa y basada en evidencia como una herramienta fundamental para la toma de decisiones informadas.</li>
                    <li>Respeto: Fomentamos un ambiente de respeto mutuo y aceptación de la diversidad en todas sus formas.</li>
